   ...
   function moveRoom(room,remaincount,totalcount,pwd) {
	...
	<script type="text/javascript">
		...
		function lineRender(ChatVO, updown){
			...
			str += "			<div class=\"caption\">";
			str += "			<h4>" +ChatVO.name+"</h4>";
			str += "			<h4>remaincount : " +ChatVO.remaincount+"</h4>";
			str += "			<h4>totalcount : " +ChatVO.totalcount+"</h4>";
			str += "			<h4>pwd : " +ChatVO.pwd+"</h4>";
			str += "			<p> RickyOffical</p>";
			str += "			<p> 조회수 5만 4분전</p>";
			str += "		</div>";
			str += "	</div>";
